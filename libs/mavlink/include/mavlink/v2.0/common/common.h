...
/** @brief Enumeration of engine actions */
#ifndef HAVE_ENUM_MAV_ENGINE_ACTION
#define HAVE_ENUM_MAV_ENGINE_ACTION
typedef enum MAV_ENGINE_ACTION
{
   MAV_ENGINE_ACTION_STOP=0, /* Stop. | */
   MAV_ENGINE_ACTION_START=1, /* Starting. | */
   MAV_ENGINE_ACTION_1=2, /* Reserved. | */
   MAV_ENGINE_ACTION_2=3, /* Reserved. | */
   MAV_ENGINE_ACTION_3=4, /* Reserved. | */
   MAV_ENGINE_ACTION_ENUM_END=5, /*  | */
} MAV_ENGINE_ACTION;
#endif

/** @brief Enumeration of motor actions */
#ifndef HAVE_ENUM_MAV_STG_DO
#define HAVE_ENUM_MAV_STG_DO
typedef enum MAV_STG_DO
{
   MAV_STG_DO_WAIT=0, /* Waiting. | */
   MAV_STG_DO_START=1, /* Starting. | */
   MAV_STG_DO_STOP_STARTING=2, /* Stop starting. | */
   MAV_STG_DO_HORIZON=3, /* Turn to horizon. | */
   MAV_STG_DO_VERTICALC=4, /* Turt to vertical. | */
   MAV_STG_DO_ENUM_END=5, /*  | */
} MAV_STG_DO;
#endif

/** @brief Motor state. */
#ifndef HAVE_ENUM_MAV_STG_MOTOR_STATE
#define HAVE_ENUM_MAV_STG_MOTOR_STATE
typedef enum MAV_STG_MOTOR_STATE
{
   MAV_STG_MOTOR_STATE_WAITING=0, /* Waiting. | */
   MAV_STG_MOTOR_STATE_STARTING=1, /* Starting. | */
   MAV_STG_MOTOR_STATE_STARTED=2, /* Started. | */
   MAV_STG_MOTOR_STATE_ERROR=3, /* Fault. | */
   MAV_STG_MOTOR_STATE_ENUM_END=4, /*  | */
} MAV_STG_MOTOR_STATE;
#endif

/** @brief STG's bitmask errors. */
#ifndef HAVE_ENUM_MAV_STG_FLAG_ERRORS
#define HAVE_ENUM_MAV_STG_FLAG_ERRORS
typedef enum MAV_STG_FLAG_ERRORS
{
   MAV_STG_FLAG_ERRORS_STARTING_FAILURE=1, /* Motor starting failure. | */
   MAV_STG_FLAG_ERRORS_INCONSISTENT_HALLS=2, /* Hall values inconsistent. | */
   MAV_STG_FLAG_ERRORS_STALLED_CRANCKSHAFT=4, /* Cranckshaft stalled. | */
   MAV_STG_FLAG_ERRORS_CRYSTAL_FAILURE=8, /* Crystal failure, HSI enabled. | */
   MAV_STG_FLAG_ERRORS_START_CANCELLATION=16, /* Start cancellation. | */
   MAV_STG_FLAG_ERRORS_RESERVED_1=32, /* Reserved for future use. | */
   MAV_STG_FLAG_ERRORS_RESERVED_2=64, /* Reserved for future use. | */
   MAV_STG_FLAG_ERRORS_RESERVED_3=128, /* Reserved for future use. | */
   MAV_STG_FLAG_ERRORS_ENUM_END=129, /*  | */
} MAV_STG_FLAG_ERRORS;
#endif
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_STG_ACTION=20001, /* Motor action. |Action.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   ...
   MAV_CMD_SWITCH_REMOTE_OVERRIDE_MODE=60300, /* Switch between remote control mode and channels override mode. |toggle| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_DO_ENGINE_ACTION=60606, /* Engine action. |Engine action.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
   MAV_CMD_RELEASE_BUFFER_PARACHUTE=60666, /* Release buffer and parachute. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_DROP_BUFFER_PARACHUTE=60667, /* Drop buffer and parachute. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENUM_END=60668, /*  | */
} MAV_CMD;
#endif
...
#include "./mavlink_msg_stg_status.h"
